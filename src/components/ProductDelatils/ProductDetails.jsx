...
class ProductDetails extends React.Component {
  render() {
    ...
    let CustomeView = this.props.Products.filter((ele) => {
            ...
            <div className="col-md-6 box-info">
              ...
              <div className="buyProduct">
                <div className="count lead ">
                  <button onClick={() => this.props.onDecrement(product)}>
                    -
                  </button>
                  <span>{product.count}</span>
                  <button onClick={() => this.props.onIncrement(product)}>
                    +
                  </button>
                </div>
                <button
                  style={
                    product.incart === true
                      ? { color: "#e91e63", border: '1px solid #253b70' }
                      : { color: "#253b70", background: "white", border: '1px solid #253b70' }
                  }
                  onClick={() => {
              ...
              <div className="Categories">
                ...
                <NavLink className="linksPages" to="/">
                  all
                </NavLink>
